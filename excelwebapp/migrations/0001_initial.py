# Generated by Django 5.2.6 on 2025-12-04 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_duration_in_days', models.FloatField(blank=True, default=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('investment_name', models.CharField(max_length=64, null=True)),
                ('minimum_amount', models.FloatField(default=0)),
                ('maximum_amount', models.FloatField(default=0)),
                ('return_of_investment', models.CharField(blank=True, null=True)),
                ('duration', models.IntegerField(default=0)),
                ('referral', models.CharField(max_length=200, null=True)),
                ('principal', models.CharField(choices=[('Included', 'Included'), ('Not Included', 'Not Included')], default='Included', max_length=200)),
                ('duration_measurement', models.CharField(choices=[('Hours', 'Hours'), ('Days', 'Days')], default='Days', max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='Video',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_code', models.CharField(max_length=11, null=True)),
                ('is_valid', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='excelwebapp.client')),
            ],
        ),
        migrations.CreateModel(
            name='EmailOTP',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='excelwebapp.client')),
            ],
        ),
        migrations.CreateModel(
            name='Payment_id',
            fields=[
                ...
                ('investment_plan_name', models.CharField(blank=True, default='MISSED-INFO', max_length=20, null=True)),
                ('contract_duration', models.FloatField(blank=True, default=10, null=True)),
